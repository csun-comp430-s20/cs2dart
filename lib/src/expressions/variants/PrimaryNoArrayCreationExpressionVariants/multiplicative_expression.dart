...
class MultiplicativeExpression implements PrimaryNoArrayCreationExpression {
  MultiplicativeExpression(
    this._value,
  ) : super();

  static final PrimaryNoArrayCreationExpressionType _type =
      PrimaryNoArrayCreationExpressionType.multiplicative_expression;
  final List _value;

  @override
  PrimaryNoArrayCreationExpressionType get type {
    assert(_type == PrimaryNoArrayCreationExpressionType.multiplicative_expression);
    return _type;
  }
