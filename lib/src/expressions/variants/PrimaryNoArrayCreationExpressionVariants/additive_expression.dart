...
class AdditiveExpression implements PrimaryNoArrayCreationExpression {
  AdditiveExpression(
    this._value,
  ) : super();

  static final PrimaryNoArrayCreationExpressionType _type =
      PrimaryNoArrayCreationExpressionType.additive_expression;
  final List _value;

  @override
  PrimaryNoArrayCreationExpressionType get type {
    assert(_type == PrimaryNoArrayCreationExpressionType.additive_expression);
    return _type;
  }
